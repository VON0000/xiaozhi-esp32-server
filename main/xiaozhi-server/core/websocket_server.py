...
class WebSocketServer:
    def __init__(self, config: dict):
        ...
        self._vad, self._asr, self._llm, self._tts, self._memory = self._create_processing_instances()
    ...
    async def _handle_connection(self, websocket):
        ...
        handler = ConnectionHandler(self.config, self._vad, self._asr, self._llm, self._tts, self._memory)
